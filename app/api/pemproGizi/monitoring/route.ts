...
// ========================================================
// GET: Ambil semua kegiatan & pelaksanaan untuk Monitoring Gizi (lengkap)
// ========================================================
export async function GET() {
  try {
    const kegiatanGizi = await prisma.kegiatan.findMany({
      where: {
        programKesehatan: {
          nama: {
    ...
    const data = kegiatanGizi.map(g => ({
      id: g.id,
      nama: g.nama,
      deskripsi: g.deskripsi,
      tanggalPelaksanaan: g.tanggalPelaksanaan,
      alamat: g.alamat,
      posyandu: g.posyandu,
      programKesehatan: g.programKesehatan,
      pelaksanaan: g.pelaksanaanKegiatan.map(p => ({
        id: p.id,
    ...
    console.error('[GET pemproGiziMonitoring]', error);

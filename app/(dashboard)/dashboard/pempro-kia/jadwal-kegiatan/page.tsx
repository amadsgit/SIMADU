...
export default function JadwalKegiatanPage() {
  ...
  // Fetch data dari API kegiatan KIA
  useEffect(() => {
  ...
  return (
    <div className="p-2 text-gray-800">
      ...
      <div className="mb-4 flex gap-4 items-center text-sm text-gray-600">
        ...
        <span>Kalender & Daftar Kegiatan KIA</span>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Kalender */}
            ...
            <div className="flex justify-between items-center mb-4">
                ...
                <Link href="/dashboard/pempro-kia/jadwal-kegiatan/create">
              ...
              <tbody>
                {currentRows.length === 0 ? (
                  <tr>
                    <td
                      colSpan={6}
                      className="text-center py-6 text-gray-500 italic animate-fadeIn"
                    >

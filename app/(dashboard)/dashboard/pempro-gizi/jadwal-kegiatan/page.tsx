...
export default function JadwalKegiatanPage() {
  ...
  // Fetch data dari API kegiatan Gizi
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch('/api/pemproGizi/jadwal');
  ...
  const handleDelete = async () => {
    ...
    try {
      const res = await fetch(`/api/pemproGizi/jadwal/${selectedId}`, {
        method: 'DELETE',
      });
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Kalender */}
            ...
            <div className="flex justify-between items-center mb-4">
                ...
                <Link href="/dashboard/pempro-gizi/jadwal-kegiatan/create">
              ...
              <tbody>
                {currentRows.length > 0 ? (
                    ...
                    <tr key={k.id} className="odd:bg-gray-50">
                      ...
                      <td>
                        <div className="flex justify-center items-center gap-2">
                          <Link
                            href={`/dashboard/pempro-gizi/jadwal-kegiatan/${k.id}/edit`}
                  ...
                  <tr>
                    <td
                      colSpan={6}
                      className="text-center py-6 text-gray-500 italic bg-gray-50 rounded-md"
                    >

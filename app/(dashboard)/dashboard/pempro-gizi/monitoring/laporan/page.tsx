...
import TabsPane from '@/components/tab-pane-pemprogizi';
...
export default function MonitoringGiziPage() {
  ...
  useEffect(() => {
    setLoading(true);
    fetch("/api/pemproGizi/monitoring")
      .then((res) => res.json())
      .then((res) => {
  ...
  function printRows(rowsToPrint: Array<{ kegiatan: Kegiatan; pelaksanaan: Pelaksanaan }>, title = "Laporan Kegiatan Gizi") {
    ...
    <div>
      ...
      <div className="bg-white shadow rounded p-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => printRows(filteredRows, "Laporan Kegiatan Gizi (Filter saat ini)") }
            ...
            <button
              onClick={() => printRows(filteredRows.length ? filteredRows : flatRows, "Laporan Kegiatan Gizi (Semua Data)") }
